<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="<?php base_url('/stisla/mahasiswa') ?>">UA University</a>
        </div>
        <div class="sidebar-brand sidebar-brand-sm">
            <a href="<?php base_url('/stisla/mahasiswa') ?>">UA</a>
        </div>
        <ul class="sidebar-menu">
            ...
            <li>
                <a class="nav-link" href="<?php echo base_url('auth/logout') ?>"> <i class="fas fa-sign-out-alt text-danger"></i> <span>Logout</span></a>
            </li>
        </ul>
    </aside>
</div>